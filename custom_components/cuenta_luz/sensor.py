...
from .test_cuenta_luz import obtener_tarifas  # tu código de Selenium
...
class TarifaSensor(SensorEntity):
    ...
    async def async_update(self):
        data = obtener_tarifas(self._attr_name.split(" ")[2])
        self._attr_native_value = data.get(self._attr_name.split(" ", 3)[-1], self._attr_native_value)
